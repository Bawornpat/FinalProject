...
public class Pract_6Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pract_6);

        cs1 = findViewById(R.id.Speech6_1);
        cs2 = findViewById(R.id.Speech6_2);
        cs3 = findViewById(R.id.Speech6_3);
        cs4 = findViewById(R.id.Speech6_4);
        cs5 = findViewById(R.id.Speech6_5);

        btnSend = findViewById(R.id.btn_send6);
        ...
        btnSend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AlertDialog.Builder builder =
                        new AlertDialog.Builder(Pract_6Activity.this);
            ...
            case RESULT_SPEECH: {
                if (resultCode == RESULT_OK && null != data) {
                    ...
                    if (countBtn == 1 && checkBtn1==0 ){
                        if (text.contains("นอหนู")||text.contains("จ.จาน")){
                            checkBtn1=1;
                            score1=1;
                            Toast.makeText(Pract_6Activity.this,"ถูกต้อง",Toast.LENGTH_SHORT).show();


                        }else if (text.contains("นอ")||text.contains("หนู")){
                            checkBtn1=1;
                            score1=0.5;
                            Toast.makeText(Pract_6Activity.this,"ใกล้เคียง",Toast.LENGTH_SHORT).show();

                        }else {
                            checkBtn1=1;
                            score1=0;
                            Toast.makeText(Pract_6Activity.this,"ผิด",Toast.LENGTH_SHORT).show();

                        }

                        /** 2 **/
                    }else if (countBtn == 2 && checkBtn2==0 ){
                        if (text.contains("ฉฉิ่ง")|| text.contains("ชอชิ่ง")){
                            checkBtn2=1;
                            score2=1;
                            Toast.makeText(Pract_6Activity.this,"ถูกต้อง",Toast.LENGTH_SHORT).show();
                        ...
                        }else if (text.contains("ฉอ")||text.contains("ฉิ่ง")||text.contains("ชิง")){
                            checkBtn2=1;
                            score2=0.5;
                            Toast.makeText(Pract_6Activity.this,"ใกล้เคียง",Toast.LENGTH_SHORT).show();
                        ...
                        if (text.contains("ทอทหาร")||text.contains("ท.ทหาร")||text.contains("ถอทหาร")){

                            checkBtn3=1;
                            score3=1;
                            Toast.makeText(Pract_6Activity.this,"ถูกต้อง",Toast.LENGTH_SHORT).show();

                        }else if (text.contains("ทอ")||text.contains("ถอ")||text.contains("ทหาร")){
                        ...
                        if (text.contains("ทอมนโท")||text.contains("ทอมมนโทร")||text.contains("ทอมณโฑ")||text.contains("มฌโท")){

                            checkBtn4=1;
                            score4=1;
                            Toast.makeText(Pract_6Activity.this,"ถูกต้อง",Toast.LENGTH_SHORT).show();

                        }else if (text.contains("โทร")){
                        ...
                        }else if (text.contains("หอ")||text.contains("หีบ")||text.contains("ขอหีบ")){
