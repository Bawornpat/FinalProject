...
public class Pract_3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pract_3);

        cs1 = findViewById(R.id.Speech3_1);
        cs2 = findViewById(R.id.Speech3_2);
        cs3 = findViewById(R.id.Speech3_3);
        cs4 = findViewById(R.id.Speech3_4);
        cs5 = findViewById(R.id.Speech3_5);

        btnSend = findViewById(R.id.btn_send3);
        ...
        btnSend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AlertDialog.Builder builder =
                        new AlertDialog.Builder(Pract_3Activity.this);
            ...
            case RESULT_SPEECH: {
                if (resultCode == RESULT_OK && null != data) {
                    ...
                    if (countBtn == 1 && checkBtn1==0 ){
                        if (text.contains("คอควาย")||text.contains("ขอควาย")){
                            checkBtn1=1;
                            score1=1;
                            Toast.makeText(Pract_3Activity.this,"ถูกต้อง",Toast.LENGTH_SHORT).show();


                        }else if (text.contains("คอ")||text.contains("ควาย")||text.contains("คอกควาย")||text.contains("เขาควาย")){
                            checkBtn1=1;
                            score1=0.5;
                            Toast.makeText(Pract_3Activity.this,"ใกล้เคียง",Toast.LENGTH_SHORT).show();
                            ...
                            checkBtn1=1;
                            score1=0;
                            Toast.makeText(Pract_3Activity.this,"ผิด",Toast.LENGTH_SHORT).show();

                        }

                        /** 2 **/
                    }else if (countBtn == 2 && checkBtn2==0 ){
                        if (text.contains("ดอเด็ก")|| text.contains("ดอเดก")){
                            checkBtn2=1;
                            score2=1;
                            Toast.makeText(Pract_3Activity.this,"ถูกต้อง",Toast.LENGTH_SHORT).show();
                        ...
                        }else if (text.contains("ดอ")||text.contains("เด็ก")||text.contains("เดก")){
                            checkBtn2=1;
                            score2=0.5;
                            Toast.makeText(Pract_3Activity.this,"ใกล้เคียง",Toast.LENGTH_SHORT).show();
                        ...
                        if (text.contains("ศ.ศาลา")||text.contains("ศอศาลา")||text.contains("ศศาลา")){

                            checkBtn3=1;
                            score3=1;
                            Toast.makeText(Pract_3Activity.this,"ถูกต้อง",Toast.LENGTH_SHORT).show();

                        }else if (text.contains("ศ")||text.contains("ศอ")||text.contains("ศาลา")||text.contains("ซาร่า")){
                        ...
                        if (text.contains("ตอเต่า")||text.contains("ต.เต่า")||text.contains("ตเต่า")){

                            checkBtn4=1;
                            score4=1;
                            Toast.makeText(Pract_3Activity.this,"ถูกต้อง",Toast.LENGTH_SHORT).show();

                        }else if (text.contains("ตอ")||text.contains("เต่า")||text.contains("ต่อ")){
                        ...
                        if (text.contains("คอคน")||text.contains("ขอคน")){
                        ...
                        }else if (text.contains("คอ")||text.contains("คน")||text.contains("ฅน")){
