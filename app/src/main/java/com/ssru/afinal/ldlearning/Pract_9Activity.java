...
public class Pract_9Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pract_9);
        cs1 = findViewById(R.id.Speech9_1);
        cs2 = findViewById(R.id.Speech9_2);
        cs3 = findViewById(R.id.Speech9_3);
        cs4 = findViewById(R.id.Speech9_4);
        cs5 = findViewById(R.id.Speech9_5);

        btnSend = findViewById(R.id.btn_send9);
        ...
        btnSend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AlertDialog.Builder builder =
                        new AlertDialog.Builder(Pract_9Activity.this);
            ...
            case RESULT_SPEECH: {
                if (resultCode == RESULT_OK && null != data) {
                    ...
                    if (countBtn == 1 && checkBtn1==0 ){
                        if (text.contains("ลองลิง")||text.contains("รอริง")||text.contains("รอลิง")){
                            checkBtn1=1;
                            score1=1;
                            Toast.makeText(Pract_9Activity.this,"ถูกต้อง",Toast.LENGTH_SHORT).show();


                        }else if (text.contains("รอ")||text.contains("ลอ")||text.contains("ลิง")){
                            checkBtn1=1;
                            score1=0.5;
                            Toast.makeText(Pract_9Activity.this,"ใกล้เคียง",Toast.LENGTH_SHORT).show();

                        }else {
                            checkBtn1=1;
                            score1=0;
                            Toast.makeText(Pract_9Activity.this,"ผิด",Toast.LENGTH_SHORT).show();
                        }

                        /** 2 **/
                    }else if (countBtn == 2 && checkBtn2==0 ){
                        if (text.contains("สอเสือ")){

                            checkBtn3=1;
                            score3=1;
                            Toast.makeText(Pract_9Activity.this,"ถูกต้อง",Toast.LENGTH_SHORT).show();

                        }else if (text.contains("สอ")||text.contains("เสือ")){
                        ...
                        if (text.contains("วอแหวน")||text.contains("วแหวน")){

                            checkBtn4=1;
                            score4=1;
                            Toast.makeText(Pract_9Activity.this,"ถูกต้อง",Toast.LENGTH_SHORT).show();

                        }else if (text.contains("วอ")||text.contains("แหวน")||text.contains("วงแหวน")){
                        ...
                        if (text.contains("อออ่าง")){

                            checkBtn4=1;
                            score4=1;
                            Toast.makeText(Pract_9Activity.this,"ถูกต้อง",Toast.LENGTH_SHORT).show();

                        }else if (text.contains("ออ")||text.contains("อ่าง")||text.contains("อ.")){
                        ...
                        }else if (text.contains("หอนกฮูก")||text.contains("นกฮูก")){
