...
public class Pract_5Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pract_5);

        cs1 = findViewById(R.id.Speech5_1);
        cs2 = findViewById(R.id.Speech5_2);
        cs3 = findViewById(R.id.Speech5_3);
        cs4 = findViewById(R.id.Speech5_4);


        btnSend = findViewById(R.id.btn_send5);
        ...
        btnSend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AlertDialog.Builder builder =
                        new AlertDialog.Builder(Pract_5Activity.this);
            ...
            case RESULT_SPEECH: {
                if (resultCode == RESULT_OK && null != data) {
                    ...
                    if (countBtn == 1 && checkBtn1==0 ){
                        if (text.contains("ชอกะเชอ")||text.contains("ฌอกะเฌอ")|| text.contains("ชอกระเชอ")){
                            checkBtn1=1;
                            score1=1;
                            Toast.makeText(Pract_5Activity.this,"ถูกต้อง",Toast.LENGTH_SHORT).show();


                        }else if (text.contains("ชอ")||text.contains("ฌอ")||text.contains("กะเชอ")||text.contains("กระเชอ")||text.contains("กะเฌอ")||text.contains("กระเฌอ")){
                            checkBtn1=1;
                            score1=0.5;
                            Toast.makeText(Pract_5Activity.this,"ใกล้เคียง",Toast.LENGTH_SHORT).show();

                        }else {
                            checkBtn1=1;
                            score1=0;
                            Toast.makeText(Pract_5Activity.this,"ผิด",Toast.LENGTH_SHORT).show();

                        }

                        /** 2 **/
                    }else if (countBtn == 2 && checkBtn2==0 ){
                        if (text.contains("ยอหญิง")|| text.contains("ญอหญิง")){
                            checkBtn2=1;
                            score2=1;
                            Toast.makeText(Pract_5Activity.this,"ถูกต้อง",Toast.LENGTH_SHORT).show();
                        ...
                        }else if (text.contains("ยอ")||text.contains("ญอ")||text.contains("หญิง")){
                            checkBtn2=1;
                            score2=0.5;
                            Toast.makeText(Pract_5Activity.this,"ใกล้เคียง",Toast.LENGTH_SHORT).show();
                        ...
                        if (text.contains("นอนเณร")||text.contains("นอนเอน")){

                            checkBtn3=1;
                            score3=1;
                            Toast.makeText(Pract_5Activity.this,"ถูกต้อง",Toast.LENGTH_SHORT).show();

                        }else if (text.contains("นอน")||text.contains("เณร")){
                        ...
                        if (text.contains("ทอผู้เท่า")||text.contains("พอผู้เท่า")){

                            checkBtn4=1;
                            score4=1;
                            Toast.makeText(Pract_5Activity.this,"ถูกต้อง",Toast.LENGTH_SHORT).show();

                        }else if (text.contains("ทอ")||text.contains("พอ")||text.contains("ผู้เฒ่า")||text.contains("เฒ่า")){
