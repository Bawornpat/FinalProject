...
public class Pract_8Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pract_8);
        cs1 = findViewById(R.id.Speech8_1);
        cs2 = findViewById(R.id.Speech8_2);
        cs3 = findViewById(R.id.Speech8_3);
        cs4 = findViewById(R.id.Speech8_4);
        cs5 = findViewById(R.id.Speech8_5);

        btnSend = findViewById(R.id.btn_send8);
        ...
        btnSend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AlertDialog.Builder builder =
                        new AlertDialog.Builder(Pract_8Activity.this);
            ...
            case RESULT_SPEECH: {
                if (resultCode == RESULT_OK && null != data) {
                    ...
                    if (countBtn == 1 && checkBtn1==0 ){
                        if (text.contains("บอใบไม้")||text.contains("จ.จาน")){
                            checkBtn1=1;
                            score1=1;
                            Toast.makeText(Pract_8Activity.this,"ถูกต้อง",Toast.LENGTH_SHORT).show();


                        }else if (text.contains("ใบไม้")||text.contains("บอ")){
                            checkBtn1=1;
                            score1=0.5;
                            Toast.makeText(Pract_8Activity.this,"ใกล้เคียง",Toast.LENGTH_SHORT).show();

                        }else {
                            checkBtn1=1;
                            score1=0;
                            Toast.makeText(Pract_8Activity.this,"ผิด",Toast.LENGTH_SHORT).show();

                        }

                        /** 2 **/
                    }else if (countBtn == 2 && checkBtn2==0 ){
                        if (text.contains("ปอปลา")){
                            checkBtn2=1;
                            score2=1;
                            Toast.makeText(Pract_8Activity.this,"ถูกต้อง",Toast.LENGTH_SHORT).show();
                        ...
                        }else if (text.contains("ปอ")||text.contains("ปลา")){
                            checkBtn2=1;
                            score2=0.5;
                            Toast.makeText(Pract_8Activity.this,"ใกล้เคียง",Toast.LENGTH_SHORT).show();
                        ...
                        if (text.contains("สอฤาษี")||text.contains("ฤาษี")||text.contains("ฤๅษี")){

                            checkBtn3=1;
                            score3=1;
                            Toast.makeText(Pract_8Activity.this,"ถูกต้อง",Toast.LENGTH_SHORT).show();

                        }else if (text.contains("สอ")||text.contains("สี")){
                        ...
                        if (text.contains("รอเรือ")){

                            checkBtn4=1;
                            score4=1;
                            Toast.makeText(Pract_8Activity.this,"ถูกต้อง",Toast.LENGTH_SHORT).show();

                        }else if (text.contains("รอ")||text.contains("เรือ")||text.contains("ลอ")){
                        ...
                        }else if (text.contains("ทอ")||text.contains("ธง")){
